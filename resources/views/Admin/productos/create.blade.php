...
@section('content')
<h2 class="text-center mb-5">Crear prendas</h2>

<div class="row justify-content-center mt-5">
   <div class="col-md-8">
       <form method="POST" enctype="multipart/form-data" action="{{route('productos.store')}}" novalidate>
          @csrf
             ...
             <label for="subcategoria_id">Subcategoria</label>
              ...
              <select name="subcategoria_id" 
                      ...
                      @foreach($subcategorias as $subcategoria)
                          <option value="{{ $subcategoria->id }}" {{old('subcategoria') == $subcategoria->id ? 'selected' : ''}}
         ...
         <div class="form-group">
            ...
            <input type="text" name="precio" class="form-control @error('precio') is-invalid @enderror" id="precio" placeholder="precio Prenda"/>
         ...
         <div class="form-group">
            ...
            <input type="text" name="talle" class="form-control @error('talle') is-invalid @enderror" id="talle" placeholder="talle Prenda"/>
         ...
         <div class="form-group">
             ...
             <input type="hidden" name="descripcion"  id="descripcion" placeholder="descripcion Prenda" value="{{old('descripcion')}}"/>
