...
@section('content')
<h2 class="text-center mb-5">Editar subcategorias</h2>

<div class="row justify-content-center mt-5">
   <div class="col-md-8">

       <form method="POST" enctype="multipart/form-data" action="{{route('subcategorias.update', $subcategoria)}}" novalidate>
          @csrf
          ...
          <div class="form-group">
            ...
            <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" id="nombre" placeholder="nombre Prenda" value = "{{ $subcategoria->nombre }}"/>
